...
def run_experiment(exp):
    ...
    print("Pickled exp equals original exp: ", test_pickled_exp.substrate==exp.substrate)
    print("Pickled exp equals original exp: ", test_pickled_exp.params==exp.params)
