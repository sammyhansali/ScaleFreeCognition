...
class RandomActivationByBreed(RandomActivation):
    ...
    def organ_focused_fitness(self):
        ...
        # Calculations
        ## Base scores
        eye_base_score = 25*(nb_eye_matched/nb_eye_goal) # Max score of 20
        nose_mouth_base_score = 25*(nb_nose_mouth_matched/nb_nose_mouth_goal) # Max score of 20
        skin_base_score = 30*(nb_skin_matched/nb_skin_goal) # Max score of 20
        ...
        if nb_nose_mouth_goal==nb_nose_mouth_matched:
            fitness_score+=10
            matches+=1
        if nb_skin_goal==nb_skin_matched:
            matches+=1
