...
class Cell(Agent):
    ...
    def update_direction(self):
        self.direction = self.update_history(self.direction, outputs["direction"])
    ...
    def step(self):
        ...
        # self.send_molecs_and_stress(outputs)
        ...
        # Can only divide when you stop changing directions
