...
class Cell(Agent):
    ...
    def update_local_fitness(self):
        self.local_fitness = update_history(self.local_fitness, self.model.schedule.local_fitness(self)/100)
        return self.local_fitness
    
    def update_global_fitness(self):
        self.global_fitness = update_history(self.global_fitness, self.model.schedule.global_fitness()/100)
