    ...
    def cell_division(self, probability):
        ...
        if probability == 1:
            ...
            cell = Cell(self.net, self.depth, self.model.next_id(), (x,y), self.model,  True, 
                              self.molecules, self.energy, self.energyt1, self.cell_gain_from_good_state,  self.goal[y][x], 
                              self.GJ_opening_molecs, self.GJ_opening_stress, self.stress, self.decision_state0, self.decision_state1, 
