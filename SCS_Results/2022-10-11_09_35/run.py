...
def eval_individual(genome):
    ...
    genome.BuildESHyperNEATPhenotype(net, experiment.substrate, experiment.params)
    depth = experiment.params.MaxDepth
    net.Flush()


    model = Multicellularity_model(net=net, depth=depth, height= experiment.height, width= experiment.width, 
    initial_cells=experiment.initial_cells,
    energy = experiment.energy,
    step_count = experiment.step_count,
    nb_gap_junctions = experiment.nb_gap_junctions,
    fitness= experiment.fitness_function,
