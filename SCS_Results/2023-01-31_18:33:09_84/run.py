...
def run_experiment(exp):
    ...
    for generation in range(exp.nb_gens):
        ...
        if generation == 1:
            print("Expected:", gen_best_fitness)
            print("Try 1", str(eval_individual(gen_best_genome)))
            print("Try 2", str(eval_individual(gen_best_genome)))
            print("Try 3", str(eval_individual(gen_best_genome)))
