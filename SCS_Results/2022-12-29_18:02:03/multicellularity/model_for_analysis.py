...
class Multicellularity_model(Model):
    ...
    def __init__(self,
        ...
        for i in range(nb_output_molecules):
            ...
            datacollector_dict[f"Molecule {i} exchanged"] =  self.get_nb_molecules_exchanged(Cell, i)
        ...
        if self.nb_output_molecules > 1:
            ...
            datacollector_dict[f"Total molecules exchanged"] =  self.get_nb_molecules_exchanged(Cell, "total")
