...
class Cell(Agent):
    ...
    def step(self):
        ...
        if "cell_type" in outputs:
            ...
            if outputs["cell_type"] == 1 and abs(-60 - self.potential[0]) < 15:
                self.differentiate(1)
            elif outputs["cell_type"] == 2 and abs(-50 - self.potential[0]) < 15:
                self.differentiate(2)
            elif outputs["cell_type"] == 3 and abs(-40 - self.potential[0]) < 15:
