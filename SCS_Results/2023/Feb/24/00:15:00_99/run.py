...
def run_experiment(exp):
    ...
    shutil.copyfile("analysis.py",  f"SCS_Results/{file}/analysis.py")
    shutil.copyfile("run_analysis.py",  f"SCS_Results/{file}/run_analysis.py")
    shutil.copyfile("random_faces.py",  f"SCS_Results/{file}/random_faces.py")
    shutil.copyfile("run.py",  f"SCS_Results/{file}/run.py")
    shutil.copyfile("experiment.py",  f"SCS_Results/{file}/experiment.py")
    shutil.copytree('./multicellularity', f"SCS_Results/{file}/multicellularity")
    shutil.copytree('./Experiments', f"SCS_Results/{file}/Experiments")
    ...
    net.Load(fp)
    print(f"Expected fitness:{test_eval_individual(net, exp)}")
