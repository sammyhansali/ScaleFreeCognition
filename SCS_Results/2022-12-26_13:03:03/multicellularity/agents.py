...
class Cell(Agent):
    ...
    def __init__(self, net, depth, unique_id, pos, model, moore, molecules, bioelectric_stimulus, tissue_goal_cell_type, GJ_opening_ions, GJ_molecules, GJ_opening_stress, energy, stress, direction, global_fitness, cell_type, potential):
        """
