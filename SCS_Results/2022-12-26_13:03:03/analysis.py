...
def direction(agent):
    ...
    if agent.direction[0] == 1:     # NO
        portrayal["heading_x"] = 0
        portrayal["heading_y"] = 1
    elif agent.direction[0] == 2:   # NE
        portrayal["heading_x"] = 0.5
        portrayal["heading_y"] = 0.5
    elif agent.direction[0] == 3:   # EA
        portrayal["heading_x"] = 1
        portrayal["heading_y"] = 0
    elif agent.direction[0] == 4:   # SE
        portrayal["heading_x"] = 1
        portrayal["heading_y"] = -1
    elif agent.direction[0] == 5:   # SO
        portrayal["heading_x"] = 0
        portrayal["heading_y"] = -1
    elif agent.direction[0] == 6:   # SW
        portrayal["heading_x"] = -1
        portrayal["heading_y"] = -1
    elif agent.direction[0] == 7:   # WE
        portrayal["heading_x"] = -1
        portrayal["heading_y"] = 0
    elif agent.direction[0] == 8:   # NW
        portrayal["heading_x"] = -1
        portrayal["heading_y"] = 1
...
def get_elements(height, width, nb_output_molecules):
    ...
    others = [molecules, energy, energy_delta, direction]
    for i in others:
