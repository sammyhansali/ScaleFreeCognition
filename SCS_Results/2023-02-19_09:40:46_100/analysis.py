...
def sim(exp, best_genome):
    print(f"Expected fitness (1):{test_eval_individual(best_genome, exp)}")
...
if __name__ == '__main__':
    ...
    # print("Pickle version (analysis):", pickle.format_version)
    # print("Python version (anlaysis):", sys.version) 3.6.11
    # print("Python version (anlaysis):", sys.version_info)
