...
class Cell(Agent):
    ...
    def send_molecs(self, cell_in_contact):
    ...
    def step(self):
        ...
        self.send_molecs_and_stress(outputs) # updates state, stress, and molecs
        self.energy = self.update_history(self.energy, self.energy[0]+self.global_fitness-0.8)
