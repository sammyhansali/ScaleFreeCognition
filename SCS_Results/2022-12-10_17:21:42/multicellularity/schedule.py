        ...
        for y in range(self.model.height):
            for x in range(self.model.width):
                ...
                cell = Cell(    net = self.model.net, 
                                ...
                                bioelectric_stimulus = self.model.bioelectric_stimulus[y][x], 
                                GJ_opening_ions=0, 
                                # GJ_opening_molecs=0, 
                                GJ_opening_stress=0, 
                                # Historical data
                ...
                # cell.global_fitness[0] = self.global_fitness()/100 #Have to make it start at 0 since fit can't be calc yet
