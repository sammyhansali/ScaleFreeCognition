...
class Cell(Agent):
    ...
    def net_input(self):
        ...
        # # add input for state of neighboring cells (N=1)
        # if "nn_1" in self.model.ANN_inputs:
        #     new_input.append(
        # # try also N=2
        # Try normalizing position to be between 0 and 1
        ...
        # I can't input a matrix. List is possible tho. So how can I put goal matrix and global_state matrix in? Should I just add nearest neighbors data as inputs?
        # if "goal" in self.model.ANN_inputs:
        #     print(self.model.goal)
        #     new_input.append(self.model.goal)
