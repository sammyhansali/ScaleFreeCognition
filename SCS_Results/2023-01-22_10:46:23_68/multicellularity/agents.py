...
class Cell(Agent):
    ...
    def __init__(self, net, depth, unique_id, pos, model, moore, molecules, goal_cell_type, bioelectric_stimulus, GJ_opening_ions, GJ_molecules, GJ_opening_stress, energy, stress, direction, cell_type, potential):
        """
    ...
    def update_cell_type(self):
        ...
        multiple = 7 # 5 seems to work for 3 cell types. for 4 idk yet.
    ...
    def step(self):
        ...
        if "molecules" in self.model.ANN_inputs:
            ...
            if not "cell_type" in self.model.ANN_outputs:
        ...
        if "energy" in self.model.ANN_inputs:
            if not "global_fitness" in self.model.ANN_inputs:
