    ...
    def generate_cells(self, Cell, start):
        ...
        for i in range(self.model.height):
            for j in range(self.model.width):
                ...
                molecules = {}
                for x in range(self.model.nb_output_molecules):
                    molecules[x] = [0]*self.model.history_length

                # molecules = []
                # for i in range(self.model.nb_output_molecules):
                #     molecules.append([0]*self.model.history_length)
                # molecules = [0]*self.model.history_length
