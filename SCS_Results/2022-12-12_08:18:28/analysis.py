...
def get_elements(height, width):
    ...
    return [canvas_element, # Cell States
            canvas_element8, # potential t1
            canvas_element10, # potential t1-t0
            canvas_element11, # 
            # canvas_element9, 
            canvas_element2, # Agent's stress
            canvas_element3, # GJ_opening_ions. Light = More open. Dark = More closed.
