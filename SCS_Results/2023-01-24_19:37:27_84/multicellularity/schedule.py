...
class RandomActivationByBreed(RandomActivation):
    ...
    def organ_focused_fitness(self):
        ...
        # Calculations
        ## Base scores
        eye_base_score = 40*(nb_eye_matched/nb_eye_goal) # Max score of 40
        nose_mouth_base_score = 40*(nb_nose_mouth_matched/nb_nose_mouth_goal) # Max score of 40
        fitness_score = eye_base_score + nose_mouth_base_score
