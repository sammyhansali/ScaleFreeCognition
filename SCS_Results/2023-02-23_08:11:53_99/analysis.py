...
def test_eval_individual(net):
    ...
    fit = 0
    for i in range(5):
        model = Multicellularity_model(net = net)
        model.verbose = False
...
def sim(winner_net):
    ...
    print(f"Expected fitness:{round(test_eval_individual(winner_net),1)}")
    print(f"Expected fitness:{round(test_eval_individual(winner_net),1)}")
    print(f"Expected fitness:{round(test_eval_individual(winner_net),1)}")
    print(len(winner_net.neurons), len(winner_net.connections))
