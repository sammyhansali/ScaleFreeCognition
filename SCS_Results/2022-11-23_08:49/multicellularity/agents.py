...
class Cell(Agent):
        ...
        for neighbour in neighbours:
            if self.model.grid.is_cell_empty(neighbour)==False: # not dead
                ...
                if self.GJ_opening_stress>0:
                    ...
                    update_history( cell_in_contact.stress, 
                                    prune_stress(new_stress_amount)
                                    )
    ...
    def step(self):
        ...
        update_history(self.energy, self.energy[0])
