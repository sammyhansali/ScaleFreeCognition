...
def GJ_molecules_0(agent):
        ...
        if type(agent) is Cell and agent.GJ_molecules[0] ==0:
            portrayal["Color"] = ["grey"]
            portrayal["Shape"] = "circle"
            portrayal["Filled"] = "true"
            portrayal["Layer"] = 0
        ...
        if type(agent) is Cell and agent.GJ_molecules[0] <=0.25  and agent.GJ_molecules[0] >0:
            portrayal["Color"] = ["#173806"]
            portrayal["Shape"] = "circle"
            portrayal["Filled"] = "true"
            portrayal["Layer"] = 0
        ...
        if type(agent) is Cell and agent.GJ_molecules[0] <=0.5  and agent.GJ_molecules[0] >0.25:
            portrayal["Color"] = ["#2d6e0c"]
            portrayal["Shape"] = "circle"
            portrayal["Filled"] = "true"
            portrayal["Layer"] = 0
        ...
        if type(agent) is Cell and agent.GJ_molecules[0] <=0.75  and agent.GJ_molecules[0] >0.5:
            portrayal["Color"] = ["#47b012"]
            portrayal["Shape"] = "circle"
            portrayal["Filled"] = "true"
            portrayal["Layer"] = 0
        ...
        if type(agent) is Cell  and agent.GJ_molecules[0] >0.75:
            portrayal["Color"] = ["#62f716"]
            portrayal["Shape"] = "circle"
            portrayal["Filled"] = "true"
            portrayal["Layer"] = 0
...
def GJ_molecules_1(agent):
        ...
        if type(agent) is Cell and agent.GJ_molecules[1] ==0:
            portrayal["Color"] = ["grey"]
            portrayal["Shape"] = "circle"
            portrayal["Filled"] = "true"
            portrayal["Layer"] = 0
        ...
        if type(agent) is Cell and agent.GJ_molecules[1] <=0.25  and agent.GJ_molecules[1] >0:
            portrayal["Color"] = ["#173806"]
            portrayal["Shape"] = "circle"
            portrayal["Filled"] = "true"
            portrayal["Layer"] = 0
        ...
        if type(agent) is Cell and agent.GJ_molecules[1] <=0.5  and agent.GJ_molecules[1] >0.25:
            portrayal["Color"] = ["#2d6e0c"]
            portrayal["Shape"] = "circle"
            portrayal["Filled"] = "true"
            portrayal["Layer"] = 0
        ...
        if type(agent) is Cell and agent.GJ_molecules[1] <=0.75  and agent.GJ_molecules[1] >0.5:
            portrayal["Color"] = ["#47b012"]
            portrayal["Shape"] = "circle"
            portrayal["Filled"] = "true"
            portrayal["Layer"] = 0
        ...
        if type(agent) is Cell  and agent.GJ_molecules[1] >0.75:
            portrayal["Color"] = ["#62f716"]
            portrayal["Shape"] = "circle"
            portrayal["Filled"] = "true"
            portrayal["Layer"] = 0
...
def molecules_0(agent):
        ...
        portrayal["Shape"] = "circle"
        portrayal["Filled"] = "true"
        portrayal["text"] = str(int(agent.molecules[0][0]))
        portrayal["text_color"] = ["black"]
        portrayal["Layer"] = 0
        portrayal["r"] = 1

        if agent.molecules[0][0] >=  10 :
            portrayal["Color"] = ["#01a7ff"]
        elif agent.molecules[0][0] >= 5:
            portrayal["Color"] = ["#aad2ff"]
        else:
...
def molecules_1(agent):
        ...
        portrayal["Shape"] = "circle"
        portrayal["Filled"] = "true"
        portrayal["text"] = str(int(agent.molecules[1][0]))
        portrayal["text_color"] = ["black"]
        portrayal["Layer"] = 0
        portrayal["r"] = 1
...
def get_elements(height, width):
    ...
    ce_molecules_0 = CanvasGrid(molecules_0, height, width, 200, 200)
    ce_molecules_1 = CanvasGrid(molecules_1, height, width, 200, 200)
    ce_GJ_molecules_0 = CanvasGrid(GJ_molecules_0, height, width, 200, 200)
    ce_GJ_molecules_1 = CanvasGrid(GJ_molecules_1, height, width, 200, 200)
    ...
    ce_energy_delta = CanvasGrid(energy_delta, height, width, 200, 200)
