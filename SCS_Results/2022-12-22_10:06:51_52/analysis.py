...
def get_elements(height, width):
    ce_cell_types = CanvasGrid(cell_types, height, width, 100, 100)
    # stress = CanvasGrid(stress, height, width, 100, 100) # Potential replaced stress's code
    ce_GJ_opening_ions = CanvasGrid(GJ_opening_ions, height, width, 100, 100)

    ce_molecules = CanvasGrid(molecules, height, width, 100, 100)
    ce_molecules_0 = CanvasGrid(molecules_0, height, width, 100, 100)
    ce_molecules_1 = CanvasGrid(molecules_1, height, width, 100, 100)
    ce_GJ_molecules_0 = CanvasGrid(GJ_molecules_0, height, width, 100, 100)
    ce_GJ_molecules_1 = CanvasGrid(GJ_molecules_1, height, width, 100, 100)
