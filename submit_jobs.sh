...
mkdir -p /cluster/tufts/levinlab/shansa01/projects/SFC/jobs_logs/$CURRENT_DATE
...
#SBATCH -n "$CORES"
#SBATCH --mem=32g
#SBATCH --output="/cluster/tufts/levinlab/shansa01/projects/SFC/jobs_logs/$CURRENT_DATE/${FILE_NAME}.out"
#SBATCH --error="/cluster/tufts/levinlab/shansa01/projects/SFC/jobs_logs/$CURRENT_DATE/${FILE_NAME}.err"
...
cd /cluster/tufts/levinlab/shansa01/projects/SFC/ScaleFreeCognition
